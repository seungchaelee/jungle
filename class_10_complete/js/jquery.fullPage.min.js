        ...
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                var tooltip = options.navigationTooltips[i];
								var li;
								if(i==0) li = '<li class="active"><a href="#' + link + '"><span>' + tooltip + '</span></a>';
								else li = '<li><a href="#' + link + '"><span>' + tooltip + '</span></a>';
            ...
            if(options.navigation){
                ...
                if(name){
                    //$(SECTION_NAV_SEL).find('a[href="#' + name + '"]').addClass(ACTIVE);
										$(SECTION_NAV_SEL).find('a[href="#' + name + '"]').parent().addClass(ACTIVE);
										
                }else{
                    $(SECTION_NAV_SEL).find('li').eq(sectionIndex).find('a').addClass(ACTIVE);
										$(SECTION_NAV_SEL).find('li').eq(sectionIndex).addClass(ACTIVE);
                }
            }
        }
